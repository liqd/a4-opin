...
def test_initiator_create_flashpoll_project(client, organisation):
    ...
    response = client.post(url, {
        ...
        'module_settings-geofenceLocation': 'POLYGON((12.721618618816137 52.71100659513395,12.765563931316137 52.05384170239608,14.039977993816137 52.38699960050584,13.073181118816137 52.707678513988185,12.721618618816137 52.71100659513395))',
    })
