...
urlpatterns = [
    ...
    url(r'^(?P<organisation_slug>[-\w_]+)/projects/create-overview$',
        views.DashboardCreateOverviewView.as_view(),
        name='dashboard-project-create-overview'),
    url(r'^(?P<organisation_slug>[-\w_]+)/projects/create/idea-collection$',
        views.DashboardCreateIdeaCollectionView.as_view(),
        name='dashboard-project-create-idea-collection'),
    url(r'^(?P<organisation_slug>[-\w_]+)/projects/create/commenting-text$',
